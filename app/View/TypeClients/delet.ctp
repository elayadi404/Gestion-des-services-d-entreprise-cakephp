...
if(isset($this->request->data['TypeClient']['TYPE']) ){
	echo $this->Form->create('TypeClient').$this->Form->input("id",array('hidden'=>'true')).$this->Form->input("TYPE").$this->Form->input("remise").$this->Form->input('v1',array('type'=>'hidden','value'=>'ok')).
